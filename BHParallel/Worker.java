...
public class Worker extends Thread{
    ...
    int finishTime, int rest, int numWorkers, double xMIN, double xMAX, double yMIN, double yMAX){
    ...
    public void createTree(){
        ...
        ParallelBody.root = new Tree(new Point(XMIN, YMAX), new Point(XMAX, YMIN));
        ParallelBody.root.assignChildren(bodies);
    }
